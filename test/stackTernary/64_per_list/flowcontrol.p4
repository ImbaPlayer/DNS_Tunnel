...
struct my_ingress_headers_t {
    ...
    domain_byte_t[D_LIST_LEN] total_domain;

    domain_byte_t[D_LIST_LEN] total_domain_2;

    domain_byte_t[D_LIST_LEN] total_domain_3;

    domain_byte_t[D_LIST_LEN] total_domain_4;

    domain_byte_t[D_LIST_LEN] total_domain_5;

    domain_byte_t[D_LIST_LEN] total_domain_6;

    domain_byte_t[D_LIST_LEN] total_domain_7;
    bit_test_t bit_test;

    domain_byte_t[256] domain_list;
    domain_byte_t[64] domain_list_2;
}
   ...
   state parse_port_metadata {
    ...
    state parse_dns_query {
        ...
        transition select(hdr.q_label_len.label_len) {
            ...
            default: parse_q1_part1;
        }
    }

    state parse_q1_part1 {
        pkt.extract(hdr.domain_list_2.next);
