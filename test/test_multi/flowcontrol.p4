...
{   
    ...
    action ac_parse_ip_feature() {
        // meta.multi_result = (bit<32>)hdr.ipv4.ihl * 5;
        meta.multi_result = (bit<32>)hdr.ipv4.ihl;
        meta.multi_src_1 = 0x2;
        meta.multi_src_2 = 0x4;
    ...
    action ac_packet_forward(macAddr_t dstAddr, PortId_t port){
        ...
        bit<32> multi_test = 0x2;
        // meta.multi_src_2 = 0x4;
        meta.multi_result = meta.multi_src_1 * meta.multi_src_2;
